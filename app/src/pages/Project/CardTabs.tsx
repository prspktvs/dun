...
const CardTabs = ({
  ...
  return (
    <div className='flex items-center justify-between md:h-14 border-b-1 border-borders-purple'>
      <div className='w-full h-full grid grid-cols-3 divide-x-[1px] divide-borders-gray border-borders-purple'>
        <div
          className={clsx(
        ...
        >
          Discussions• {cardChatsLength}
          <UnreadIndicator size='sm' count={unreadDiscussions} className='relative -top-2 left-2' />
        </div>
        <div
          className={clsx(
            'flex items-center justify-center font-monaspace text-14 lg:text-sm',
