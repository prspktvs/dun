  ...
  return (
    <>
      <div className='flex md:h-[361px] bg-[#C5D4D2] flex-col '>
        <div className='flex justify-around border-b-2  border-black sm:flex-col flex-col md:flex-row'>
        ...
        <div className='flex justify-around border-b-2 border-t-2 border-black my-16 sm:flex-col flex-col md:flex-row '>
          ...
          <div className='md:border-l-2 md:border-r-2  border-black flex-1 flex-col flex'>
            <div className='md:border-b-2 border-b-2 border-black sm:border-y-2 border-y-2 md:border-y-0'>
          ...
          <div className='flex-1 flex-col flex'>
            <div className='sm:border-t-2 border-t-2 md:border-t-0 border-black'>
