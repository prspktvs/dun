...
const FEATURES: IFeatureCard[] = [
  {
    ...
    image: <img className='sm:w-[499px] w-10/12 ' src='./image 131.jpg' alt='description-image' />,
  ...
  },
  {
    ...
    image: <img className='sm:w-[499px] w-10/12 ' src='./image 132.jpg' alt='description-image' />,
  ...
  },
  {
    ...
    image: <img className='sm:w-[499px] w-10/12 ' src='./image 133.jpg' alt='description-image' />,
    backgroundImage: `url(${Lines})`,
  },
  {
    title: 'Enjoy a clear and simple interface with DUN. No fuss, just straightforward ease!',
    backgroundColor: '#FFF5D2',
    image: <img className='sm:w-[499px] w-10/12  ' src='./image 134.jpg' alt='description-image' />,
